...
const translations: Record<Language, Translations> = {
  pl: {
    ...
    setupPhone: 'Ustaw iPhone na statywie 2-3 metry od siebie',
    ...
    update: 'Aktualizuj',
    iosTip: '💡 Jeśli aktualizacja nie działa, zamknij aplikację (swipe up) i otwórz ponownie',
  ...
  en: {
    ...
    setupPhone: 'Place iPhone on a tripod 2-3 meters away',
    ...
    update: 'Update',
    iosTip: '💡 If update doesn\'t work, close the app (swipe up) and reopen',
